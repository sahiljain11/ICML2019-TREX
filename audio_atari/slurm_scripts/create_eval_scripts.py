...
envs = [['seaquest','Seaquest'],['mspacman','MsPacman'],['spaceinvaders','SpaceInvaders']]
...
# extra = '_rl_cgl_correct'
# extra = '_rl_cal_ann'
# extra = '_rl_cal_pase'
# extra = '_rl_cal_prosody_ann_pitch'
# extra = '_rl_cal_prosody_ann_energy'
# extra = '_rl_cal_prosody_pase_pitch'
# extra = '_rl_cal_prosody_pase_energy'

# extra = '_rl_cgl_cal_ann'
# extra = '_rl_cgl_cal_pase'
# extra = '_rl_cgl_cal_prosody_ann_pitch'
# extra = '_rl_cgl_cal_prosody_ann_energy'
# extra = '_rl_cgl_cal_prosody_pase_pitch'
extra = '_rl_cgl_cal_prosody_pase_energy'
