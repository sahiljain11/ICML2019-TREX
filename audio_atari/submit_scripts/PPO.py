...
PARAMS = {
    'seed': [0,1,2],
    'exp': ['rl_cgl_cal_ann','rl_cgl_cal_pase','rl_cgl_cal_prosody_ann_pitch','rl_cgl_cal_prosody_ann_energy','rl_cgl_cal_prosody_pase_pitch','rl_cgl_cal_prosody_pase_energy'],
